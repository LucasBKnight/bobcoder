the latest exe files are in the "exefiles" folder, go nuts. Note that "BobcoderM[insert async ver number]" is the Mac version and "BobcoderW[insert async ver number]" is the Windows version
